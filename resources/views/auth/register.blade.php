<x-guest-layout>
    <form method="POST" action="{{ route('employes.store') }}" class="max-w-5xl mx-auto">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <x-text-input id="salaire" class="block mt-1 w-full" type="number" step="0.01" name="salaire" :value="old('salaire')" required />
